 ...
 */
$config['site_title']                 = "prioritas-group.com";       // Site Title, example.com
$config['admin_email']                = "admin@prioritas-group.com"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
	...
	// 'smtp_port' => 587,
	'smtp_port' => 465,
	'smtp_user' => 'prio.ho.erp@gmail.com', //isi dengan gmailmu!
	'smtp_pass' => 'prioit123', //isi dengan password gmailmu!
	'mailtype'  => 'html',
	'charset'   => 'iso-8859-1',
	'wordwrap'  => TRUE,
	'charset'=>'utf-8',
...
$config['message_start_delimiter'] = '<b>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</b>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<b>';		// Error message start delimiter
$config['error_end_delimiter']     = '</b>';	// Error message end delimiter
